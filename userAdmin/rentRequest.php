...
<body style="margin-top:-1.5rem">
  ...
  <div class="container">
    ...
    <main>
      ...
      $query = "SELECT * FROM rent_requests WHERE user_id = '$user_id' AND sold_status = 2 ORDER BY request_date DESC LIMIT $offset, $records_per_page";
      ...
      <div class="pagination">
        ...
        $total_records_query = "SELECT COUNT(*) AS total FROM rent_requests WHERE sold_status=2 AND user_id = '$user_id'";
