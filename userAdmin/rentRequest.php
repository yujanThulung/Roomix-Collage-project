                ...
                <td>
                  <div class="action-icons">
                    ...
                    <form action="../control/deleteProperty.php" method="POST">
                      ...
                      <button type="submit" name="property_delete_btn" class="custom-link delete-icon"><i class="fas fa-times" style="height:25px; width:18px; padding-top:4px;"></i></i></button>
                    </form>
                  </div>
                </td>
              </tr>
