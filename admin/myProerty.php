            ...
            <tr>
              ...
              <td>
                <div class="action-icons">
                  <a href="editProperty.php" class="custom-link" style="background-color: #ffcc00;"><i
                      class="fas fa-edit text-white"></i></a>
                  <a href="propertyShow.php" class="custom-link" style="background-color: rgb(37, 37, 252);"><i
                      class="fas fa-eye text-white"></i></a>
                  <a href="#" class="custom-link" style="background-color: #5cb85c;"><i
                      class="fas fa-house-circle-check text-white"></i></a>
