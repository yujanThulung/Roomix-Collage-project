                        ...
                        <div class="mb-3">
                            ...
                            <div class="border border-dashed rounded p-4 text-center upload-area">
                                ...
                                <div class="d-flex justify-content-center align-items-center flex-column">
                                    <input type="file" class="form-control mb-3" id="fileInput" name="file" style="display: none;">
                                    ...
                                    <p>Image dimensions exceed the maximum allowed size (1080x720px). Please choose a smaller image.</p>
                                    <img src="#" alt="Uploaded Image" id="previewImage" style="max-width: 100%; display: none;">
                                </div>
                            </div>
                        </div>
