...
<body style="margin-top:-1.5rem">
  ...
  <div class="container">
    ...
    <main>
      <h1 class="dashboard-heading">Rent Request</h1>
      ...
      $filtered_property_query = "SELECT * FROM property WHERE sold_status = 2 AND user_id = " . $_SESSION['id']; //Here i add condition to filter properties based on logged-in user's user_id 
      ...
      if (isset($_POST['sort_alphabet'])) {
        ...
        $filtered_property_query = "SELECT * FROM property WHERE sold_status = 2";
                ...
                <td>
                  <div class="action-icons">
                    ...
                    <form action="../control/soldProperty.php" method="POST">
                      ...
                      <button type="submit" name="property_request_btn" class="custom-link delete-icon" style="background-color: #5cb85c;"><i class="fas fa-house-circle-check text-white"></i></button>
                    </form>
      ...
      <div class="pagination">
        ...
        $total_records_query = "SELECT COUNT(*) AS total FROM  property WHERE  sold_status= 2 AND user_id = {$_SESSION['id']}";
