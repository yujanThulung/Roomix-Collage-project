...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function validatePassword() {
        ...
        // Check if all checklist items have the "success" class
        const allChecked = Object.values(checklistItems).every(item => item.classList.contains("success"));
    
        // If all checklist items are checked, hide the password checklist
        if (allChecked) {
